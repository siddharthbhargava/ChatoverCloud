...
function insertConversationRegular(json){
...
exports.insertConversationRegular = insertConversationRegular;
...
function autoGeneratedConversationID(callback,json){	
	
	var convoID = (json.clientID).concat((json.timeStamp));
	callback(convoID);
